...
def patcher():
    ...
    def applier(source, dest, package_name):
        ...
        try:
            # shutil.move(os.path.join(ploc, dest, package_name+'.package') , bak_path)
...
class GUI(object):
    ...
    def __init__(self):
        ...
        self.root.title('9Yin English Patch')
        self.root.geometry('350x450+700+200')
        topic = "9Y BFage English Patch \n Version " + app_version
        ...
        # note1 = '1. Ensure 9YPatch placed inside app directory \'AOW\' folder.'
    ...
    def check_thread(self):
        if self.work_thread.is_alive():
            ...
            pcs.set('Complete')
            messagebox.showinfo('9Yin English Patch', 'Patching Successfull!')
            self.root.destroy()        
